<template>
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-xl-3 col-md-6" v-for="card in summaryCards" :key="card.title">
                <div :class="['card', card.background, 'text-white', 'mb-4']">
                    <div class="card-body">{{ card.title }}</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="#">{{ card.linkText }}</a>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <table class="table table-bordered" id="datatablesSimple" ref="dataTableRef">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Position</th>
                    ...
                    <tbody>
                        <tr v-for="employee in employeeData" :key="employee.name">
                            <td>{{ employee.name }}</td>
...
const summaryCards = [
    { title: 'Primary Card', linkText: 'View Details', background: 'bg-primary' },
    { title: 'Warning Card', linkText: 'View Details', background: 'bg-warning' },
    { title: 'Success Card', linkText: 'View Details', background: 'bg-success' },
    { title: 'Danger Card', linkText: 'View Details', background: 'bg-danger' },
];
...
onMounted(() => {
    ...
    if (dataTableRef.value) {
        dataTable = new DataTable(dataTableRef.value, {
            searchable: true,
