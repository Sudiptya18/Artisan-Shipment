    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <a href="https://datatables.net/" target="_blank" rel="noopener noreferrer">official DataTables documentation</a>.
            </div>
        </div>
        <div class="card mb-4">
            ...
            <div class="card-body">
                <table class="table table-bordered" id="datatablesSimpleTables" ref="dataTableRef">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Position</th>
